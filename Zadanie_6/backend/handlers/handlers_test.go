...
func newTestEnv(t *testing.T) *echo.Echo {
	...
	e.POST("/carts", ch.CreateCart)
	e.GET("/carts/:id", ch.GetCart)
	e.POST("/carts/:id/items", ch.AddItem)
	e.DELETE("/carts/:id/items/:itemId", ch.RemoveItem)
	e.DELETE("/carts/:id", ch.DeleteCart)

	e.GET("/payments", pay.GetPayments)
	e.POST("/payments", pay.CreatePayment)
	return e
}
...
func doRaw(e *echo.Echo, method, path, rawBody string) *httptest.ResponseRecorder {
...
func TestGetCart(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)

	rec := doJSON(e, "GET", "/carts/1", nil)
	assertStatus(t, rec, 200)
...
func TestGetCartNotFound(t *testing.T) {
	e := newTestEnv(t)
	assertStatus(t, doJSON(e, "GET", "/carts/999", nil), 404)
}
...
func TestAddItemToCart(t *testing.T) {
	...
	rec := doJSON(e, "POST", "/carts/1/items", cartItem(1, 3))
	body := bodyMap(rec)
...
func TestAddItemCartNotFound(t *testing.T) {
	e := newTestEnv(t)
	assertStatus(t, doJSON(e, "POST", "/carts/999/items", cartItem(1, 1)), 404)
}

func TestAddItemProductNotFound(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)
	assertStatus(t, doJSON(e, "POST", "/carts/1/items", cartItem(999, 1)), 404)
}
...
func TestGetCartWithItems(t *testing.T) {
	...
	doJSON(e, "POST", "/carts/1/items", cartItem(1, 1))
...
func TestRemoveItem(t *testing.T) {
	...
	assertStatus(t, doJSON(e, "DELETE", "/carts/1/items/1", nil), 204)
}

func TestRemoveItemNotFound(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)
	assertStatus(t, doJSON(e, "DELETE", "/carts/1/items/999", nil), 404)
}

func TestDeleteCart(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)
	assertStatus(t, doJSON(e, "DELETE", "/carts/1", nil), 204)
}

func TestDeleteCartNotFound(t *testing.T) {
	e := newTestEnv(t)
	assertStatus(t, doJSON(e, "DELETE", "/carts/999", nil), 404)
}

func TestGetCartAfterDelete(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)
	doJSON(e, "DELETE", "/carts/1", nil)
	assertStatus(t, doJSON(e, "GET", "/carts/1", nil), 404)
}
...
func TestCreatePayment(t *testing.T) {
	e := newTestEnv(t)
	rec := doJSON(e, "POST", "/payments", payment(250.0, "PAID"))
	body := bodyMap(rec)
...
func TestGetPaymentsWithData(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/payments", payment(50.0, "PAID"))
	doJSON(e, "POST", "/payments", payment(75.0, "PENDING"))
	...
	first := arr[0].(map[string]any)
	assertField(t, first, "amount", 50.0)
	assertField(t, first, "status", "PAID")
}
...
func TestMultipleCartItems(t *testing.T) {
	...
	doJSON(e, "POST", "/carts/1/items", cartItem(1, 1))
	doJSON(e, "POST", "/carts/1/items", cartItem(2, 2))
...
func TestUpdateProductInvalidBody(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/products", product("P", "D", 10.0))
	rec := doRaw(e, "PUT", "/products/1", "bad-json")
	if rec.Code != 400 && rec.Code != 500 {
		t.Fatalf("want 400 or 500, got %d", rec.Code)
	}
}

func TestAddItemInvalidBody(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/carts", nil)
	rec := doRaw(e, "POST", "/carts/1/items", "bad-json")
	if rec.Code != 400 && rec.Code != 500 {
		t.Fatalf("want 400 or 500, got %d", rec.Code)
	}
}

func TestCreatePaymentFields(t *testing.T) {
	e := newTestEnv(t)
	rec := doJSON(e, "POST", "/payments", payment(199.99, "PENDING"))
	body := bodyMap(rec)

	assertStatus(t, rec, 201)
	assertField(t, body, "amount", 199.99)
	assertField(t, body, "status", "PENDING")
	assertFieldGT(t, body, "ID", 0)
}

func TestDeleteProductThenListEmpty(t *testing.T) {
	e := newTestEnv(t)
	doJSON(e, "POST", "/products", product("OnlyOne", "D", 5.0))
	doJSON(e, "DELETE", "/products/1", nil)

	rec := doJSON(e, "GET", "/products", nil)
	assertStatus(t, rec, 200)
	if len(bodySlice(rec)) != 0 {
		t.Error("expected empty product list after delete")
	}
}
