    ...
    <div className="flex justify-center items-center py-12 px-4">
      <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="login-password">Hasło</label>
            <input
              id="login-password"
              type="password"
              placeholder="••••••••"
        ...
        <div className="space-y-3">
          <a 
            ...
            className="w-full flex items-center justify-center gap-2 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-2 rounded text-sm transition-colors shadow"
          >
          ...
          <a 
            ...
            className="w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white font-semibold py-2 rounded text-sm transition-colors shadow"
          >
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          Nie masz konta? <Link to="/register" className="text-blue-600 hover:underline font-semibold">Zarejestruj się</Link>
        </p>
      </div>
    </div>
  );
